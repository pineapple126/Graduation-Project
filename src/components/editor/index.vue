...
export default {
  ...
  methods: {
    ...
    handleMouseDown(e) {
      ...
      if (
        !this.currComponent ||
        (this.currComponent.component != "v-text" &&
          this.currComponent.component != "rect-shape")
      ) {
        e.preventDefault();
      }
      ...
      // 获取编辑器的位移信息，每次点击时都需要获取一次。主要是为了方便开发时调用。
      ...
      const move = (moveEvent) => {
        ...
        if (moveEvent.clientX < startX) {
          this.start.x = moveEvent.clientX - this.editorY;
        }
